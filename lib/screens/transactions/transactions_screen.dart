...
import 'package:afercon_pay/screens/transactions/add_transaction_screen.dart';
import 'package:afercon_pay/screens/transactions/edit_transaction_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: _isLoading
          ...
          : _currentUser == null
              ? const Center(
                  child: Text('Nenhum utilizador logado.'),
                )
                          ...
                          child: ListTile(
                            ...
                            leading: CircleAvatar(
                              ...
                              backgroundColor: isRevenue
                                  ...
                                  : const Color.fromARGB(38, 244, 67, 54),
                              child: Icon(
                                isRevenue
                                    ? Icons.arrow_upward
                            ...
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  ...
                                  _loadUserData()); // Recarrega os dados ao voltar
                            },
                          ),
                        );
                      },
