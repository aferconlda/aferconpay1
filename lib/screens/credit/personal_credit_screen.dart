...
class PersonalCreditScreen extends StatefulWidget {
  ...
  @override
  State<PersonalCreditScreen> createState() => _PersonalCreditScreenState();
}

class _PersonalCreditScreenState extends State<PersonalCreditScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: Text('Crédito Pessoal')),
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      ...
                      if (user.aoaBalance >= 0 && amount > user.aoaBalance * 0.2) {
                        return 'O montante não pode exceder 20% do seu saldo atual (${currencyFormat.format(user.aoaBalance * 0.2)}).';
                      }
                      return null;
                    },
                  ),
