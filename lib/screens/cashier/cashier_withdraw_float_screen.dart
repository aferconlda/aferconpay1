...
class CashierWithdrawFloatScreen extends StatefulWidget {
  const CashierWithdrawFloatScreen({super.key});

  @override
  State<CashierWithdrawFloatScreen> createState() => _CashierWithdrawFloatScreenState();
}

class _CashierWithdrawFloatScreenState extends State<CashierWithdrawFloatScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await _cashierService.withdrawFloatToBalance(amount);
      
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: const Text('Transferência para saldo principal concluída!'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const CustomAppBar(title: Text('Mover para Saldo Principal')),
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      ...
                      if (amount > floatBalance) {
                        return 'Não tem saldo float suficiente.';
                      }
                      return null;
                    },
                  ),
